...
Welcome to Range Mapper, a repository (is this the right word?) that allows researchers, web developers, students and other users to extract taxa-specific, spatio-temporal data from the Neotoma Paleoecology Database Collective [@williams2017neotoma]. This code also establishes a channel between Neotoma and Carto, an online mapping platform where Neotoma data can be visualized and transformed through Carto's user interface.[https://carto.com/attribution/] (NOTE FOR ANNA-- how/what do we site here? Is this what's happening?). 
